...
class MoviesFavoriteViewModelTest {
    ...
    private var viewModel = mock(MoviesFavoriteViewModel::class.java)
    ...
    fun getMoviesFavorites() {
        ...
        `when`(viewModel.getAllMoviesFavorites("movie")).thenReturn(dummyMoviesFavorites)

        viewModel.getAllMoviesFavorites("movie").observeForever(observerMoviesFavorites)
